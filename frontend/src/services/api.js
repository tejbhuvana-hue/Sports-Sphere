...
export const profilesAPI = {
  ...
  updateProfile: (formData) => api.patch('/profiles/update/', formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  }),
  toggleVerification: () => api.post('/profiles/toggle-verify/'),
  addResumeItem: (itemType, data) => api.post(`/profiles/resume/${itemType}/`, data),
  deleteResumeItem: (itemType, itemId) => api.delete(`/profiles/resume/${itemType}/${itemId}/`),
  toggleEndorsement: (playerId, category) => api.post(`/profiles/${playerId}/endorse/${category}/`),
  addRecommendation: (playerId, data) => api.post(`/profiles/${playerId}/recommend/`, data),
};
...
export const postsAPI = {
  ...
  updatePost: (postId, formData) => api.patch(`/posts/${postId}/`, formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  }),
...
export const messagesAPI = {
  ...
  sendMessage: (username, formData) => api.post(`/messages/${username}/`, formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  }),
};
...
export const recruitmentAPI = {
  ...
  apply: (id, formData) => api.post(`/recruitment/${id}/apply/`, formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  }),
  getMyApplications: () => api.get('/recruitment/my-applications/'),
  getClubDashboard: () => api.get('/club/dashboard/'),
  updateApplicationStatus: (appId, status) => api.post(`/club/applications/${appId}/status/`, { status }),
  addClubMember: (playerId) => api.post('/club/members/', { player_id: playerId }),
...
export const tournamentsAPI = {
  ...
  updateMatchScore: (matchId, data) => api.post(`/tournaments/matches/${matchId}/`, data),
};
...
export const sponsorshipsAPI = {
  ...
  updateApplicationStatus: (appId, status) => api.post(`/sponsor/applications/${appId}/status/`, { status }),
};
...
export const adminAPI = {
  ...
  toggleUserVerify: (userId) => api.post(`/admin/users/${userId}/toggle-verify/`),
  ...
  deleteEntity: (entityType, entityId) => api.delete(`/admin/entities/${entityType}/${entityId}/delete/`),
  getBlogs: () => api.get('/admin/blogs/'),
  createBlog: (formData) => api.post('/admin/blogs/', formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  }),
  updateBlog: (blogId, formData) => api.patch(`/admin/blogs/${blogId}/`, formData, {
    headers: { 'Content-Type': 'multipart/form-data' }
  }),
  deleteBlog: (blogId) => api.delete(`/admin/blogs/${blogId}/`),
  toggleBlogPublish: (blogId) => api.post(`/admin/blogs/${blogId}/toggle-publish/`),
